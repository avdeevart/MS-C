...
//Задача: перевернуть массив (певая ячека станет последне и т.д.)
//===================================================================================================================================
//-----------------------------------------------------------------------------------------------------------------------------------
...
{
    int[] workArray = GeneratingRandomValuesFillingArray(GetDigitString("Введите размер массива: "), GetDigitString("левая граница: "), GetDigitString("правая граница: "));
